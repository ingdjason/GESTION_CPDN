...
<form action="niveaux.php" method="POST" >
	<center>
		<fieldset>
		<legend><b>Enregistrer Niveaux</b></legend>
			<table>
				<tr>
				...
				<tr>
					<td><label>Libelle Niveaux</label></td>
					<td><input type="text" name="libelle" size="50" placeholder="libelle niveaux"/><br/></td>
				</tr>
			</table>
			<fieldset>
	...
	<?php 
		...
		if(isset($_POST['save']))	
		{
			...
			{ 
			$niveau=new niveau();
			$niveau->set_id_niveau($_POST['id_niveau']);
			$niveau->set_libelle_niveau($_POST['libelle']);
			$niveau->Connect();
			$niveau->Insert();
			} 
		}
