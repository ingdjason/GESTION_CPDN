...
<head>
    ...
    <title>Enregistrer Domaines</title>
...
<form action="domaines.php" method="POST" >
	<center>
		<fieldset>
		<legend><b>Enregistrer Domaines</b></legend>
			<table>
				<tr>
					<td><label>ID</label></td>
					<td><input type="number" name="id_domaines" size="50" placeholder="LAISSER VIDE"/><br/></td>
				</tr>
				<tr>
					<td><label>Libelle Domaines</label></td>
					<td><input type="text" name="libelle" size="50" placeholder="libelle domaines"/><br/></td>
				</tr>
			</table>
			<fieldset>
	...
	<?php 
		...
		if(isset($_POST['save']))	
		{
			...
			{ 
			$domaine=new domaine();
			$domaine->set_id_domaine($_POST['id_domaines']);
			$domaine->set_libelle_domaine($_POST['libelle']);
			$domaine->Connect();
			$domaine->Insert();
			} 
		}
